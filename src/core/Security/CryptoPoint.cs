...
{
    internal class CryptoPoint
    {
        public static readonly CryptoPoint INFINITY = new CryptoPoint(null, default(BigInteger), default(BigInteger));
        public CryptoCurve Curve { get; private set; }
        public BigInteger X { get; private set; }
        public BigInteger Y { get; private set; }

        public CryptoPoint(CryptoCurve curve, BigInteger x, BigInteger y)
        {
            this.Curve = curve;
            this.X = x;
            this.Y = y;
        }
        public CryptoPoint Double()
        {
            if (this == INFINITY)
                return INFINITY;
            ...
            return new CryptoPoint(this.Curve, x3, y3);
        }
        ...
        public static CryptoPoint operator +(CryptoPoint left, CryptoPoint right)
        {
            if (right == INFINITY)
                return left;
            if (left == INFINITY)
            ...
            return new CryptoPoint(left.Curve, x3, y3);
        }
